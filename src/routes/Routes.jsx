        ...
        children:[
            {
                ...
                loader:({params})=>fetch(`https://the-news-dragon-server-awoladhossain.vercel.app/catagories/${params.id}`)
            },
        ]
    },
    {
        ...
        children:[
            {
                ...
                loader:({params})=>fetch(`https://the-news-dragon-server-awoladhossain.vercel.app/news/${params.id}`)
            }
        ]
    },
])
